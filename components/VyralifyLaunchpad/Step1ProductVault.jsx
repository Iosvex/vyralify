        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="inline-flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-rose-500 to-orange-500 text-white flex items-center justify-center shadow-sm">
                <i className="ph-bold ph-rocket-launch text-base" />
              </div>
              <span className="font-extrabold text-slate-900 text-base md:text-lg tracking-tight">Product Library</span>
            </div>
          ...
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            Use our free <strong className="text-slate-900 font-bold">AI market-research tool</strong> to find a winning product from <strong className="text-slate-900 font-bold">10K+</strong> done-for-you digital products &amp; <strong className="text-slate-900 font-bold">1000+</strong> courses. Then sell through ready-made landing pages and a free store — full resell rights, keep <strong className="text-slate-900 font-bold">100%</strong> on every sale.
          </p>
        </div>
